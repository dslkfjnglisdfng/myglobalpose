...
## Official AMASS rebuild 20260712

### Orchestrator Task: official_amass_preprocess

Name: Official process.py AMASS preprocessing

Status: failed

Type: cache

Start: 2026-07-12T10:37:15

End: 2026-07-12T10:37:30
...
Command: `/home/lingfeng/.conda/envs/globalpose-gpu/bin/python -u tools/rebuild_official_amass.py --stage preprocess --raw-amass-dir /home/lingfeng/projects/data/data_raw/amass --processed data/dataset_work/AMASS/data.pt`

Log: `logs/orchestrator/official_amass_preprocess_20260712.log`

Outputs:

- `data/dataset_work/AMASS/data.pt`
...
- `official_amass_imu_synthesis`
- `official_amass_gpnet`
- `wholebody_amass_cache`

Error: missing outputs: ['data/dataset_work/AMASS/data.pt']
...
```text
# task_id=official_amass_preprocess
# experiment_id=official_amass_preprocess
# server=node01
# start=2026-07-12T10:37:15
# gpu=CPU
# checkpoint_path=
...
======================== Processing AMASS Dataset ========================
Processing HumanEva
Processing MPI_HDM05
Processing SFU
Processing MPI_mosh
Processing Transitions_mocap
Processing SSM_synced
Processing CMU
Processing DFaust67
Processing Eyes_Japan_Dataset
Processing KIT
Processing BMLmovi
Processing EKUT
Processing TCD_handMocap
Processing ACCAD
Processing BioMotionLab_NTroje
Processing BMLhandball
Processing MPI_Limits
Processing TotalCapture
Traceback (most recent call last):
  File "/home/lingfeng/projects/GlobalposeMy/GlobalPose/tools/rebuild_official_amass.py", line 132, in <module>
    main()
  File "/home/lingfeng/projects/GlobalposeMy/GlobalPose/tools/rebuild_official_amass.py", line 128, in main
    preprocess(args) if args.stage == "preprocess" else synthesize(args)
  File "/home/lingfeng/projects/GlobalposeMy/GlobalPose/tools/rebuild_official_amass.py", line 42, in preprocess
    process.process_amass(data_dir=args.raw_amass_dir, output_path=str(output))
  File "/home/lingfeng/projects/GlobalposeMy/GlobalPose/process.py", line 259, in process_amass
    assert len(data['name']) > 0, 'cannot find AMASS dataset'
AssertionError: cannot find AMASS dataset
```
...
Start: 2026-07-12T10:38:51

End: 2026-07-12T10:49:45
...
Task completed. No parser requested; see outputs and log.

### Orchestrator Task: official_amass_imu_synthesis

Name: Official imu_synthesis.py AMASS synthesis

Status: completed

Type: cache

Start: 2026-07-12T10:49:45

End: 2026-07-12T11:17:22
...
Command: `/home/lingfeng/.conda/envs/globalpose-gpu/bin/python -u tools/rebuild_official_amass.py --stage synthesize --raw-amass-dir /home/lingfeng/projects/data/data_raw/amass --processed data/dataset_work/AMASS/data.pt --output-dir data/dataset_work/AMASS/official_imu --shard-size 100 --resume`

Log: `logs/orchestrator/official_amass_imu_synthesis_20260712.log`

Outputs:

- `data/dataset_work/AMASS/official_imu/official_imu_manifest.json`

Summary:

| metric | value |
|---|---:|
| cache_version | official_globalpose_amass_imu_v1_20260712 |
| command | tools/rebuild_official_amass.py --stage synthesize --raw-amass-dir /home/lingfeng/projects/data/data_raw/amass --processed data/dataset_work/AMASS/data.pt --output-dir data/dataset_work/AMASS/official_imu --shard-size 100 --resume |
| created_utc | 2026-07-12T03:17:04.192291+00:00 |
| fps | 60 |
| num_frames | 7668224 |
| num_sequences | 10540 |
| processed_source | data/dataset_work/AMASS/data.pt |
| processed_source_sha256 | ccb24d10ecde9e3ba6f377ecd9b939db5d9f17a739471a767d549acee7d9f41f |
| producer | process.py::process_amass + imu_synthesis.py::syn_imu_from_smpl |
| raw_amass_dir | /home/lingfeng/projects/data/data_raw/amass |
