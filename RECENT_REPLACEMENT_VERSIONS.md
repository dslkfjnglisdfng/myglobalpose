...
| `IMU offset / r_JS` | `footlock_transpose_v1`, `totalcapture_accfit_rjs_20260704`, retired solver/net/hybrid routes | `totalcapture_accfit_rjs_20260704` is a promising TotalCapture acceleration diagnostic target; `footlock_transpose_v1` remains historical pseudo-offset route |
