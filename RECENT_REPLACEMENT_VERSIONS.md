...
| `IMU offset / r_JS` | `footlock_transpose_v1`, `totalcapture_accfit_rjs_20260704`, `totalcapture_both_smooth_fk_imu_acc_20260705`, retired solver/net/hybrid routes | matched smoothing confirms accfit global rJS is the best TotalCapture FK/IMU acceleration diagnostic target tested; `centered_ma21` sensor-frame specific force is the selected measurement for future smooth refinement; current bounded smooth pose/rJS refinement attempts do not pass |
