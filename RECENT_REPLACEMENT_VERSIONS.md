...
| `AccCurve / acceleration residual` | `acc_curve_v1_20260617`, `acc_curve_v1_totalcapture_eval_20260618`, `acc_curve_v1_totalcapture_zero_trans_eval_20260618`, `acc_curve_v2_gtfk_q_qdot_qddot_rjs_20260617`, `acc_curve_pl_input_eval_20260617`, `acc_invariance_datacache_v2_rebuild_20260618` | standalone acceleration-level modules; v1 full-trans TC target fails, zero-trans TC target now aligns with DIP-style contract and beats TC baseline, v2 strict GTFK remains diagnostic, and the new root-IMU-relative cache rebuild confirms shape/root-invariance while still showing raw absolute corr slightly above v2 relative mean corr; do not connect as-is |
