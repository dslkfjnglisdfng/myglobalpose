...
| `PL-s1 / joint-leaf acceleration` | `newpl_joint_leaf_acc_20260619` | base protocol repaired after finding pose_prephysics FK pl_base bug; prior full-run metrics invalid for v5 comparability until retrained |
