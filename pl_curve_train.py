...
def load_pl_curve_records(cache_path, max_sequences=0):
    ...
    if manifest is not None and manifest.get('type') in ('pl_curve_cache_v1', 'pl_curve_cache_v2', 'pl_curve_cache_v3', 'pl_curve_cache_v4'):
        records = []
...
def main():
    ...
    using_pl_cache = bool(train_manifest and train_manifest.get('type') in ('pl_curve_cache_v1', 'pl_curve_cache_v2', 'pl_curve_cache_v3', 'pl_curve_cache_v4'))
    ...
    if args.init_size != 18 and train_manifest and train_manifest.get('type') not in ('pl_curve_cache_v2', 'pl_curve_cache_v3', 'pl_curve_cache_v4'):
        raise RuntimeError(f'init_size={args.init_size} requires pl_curve_cache_v2/v3/v4 with pl_init_feature.')
